...
public class AssignmentOne {
    ...
    public static void main(String[] args) {
        ...
        GeneralPractitioner Gp1 = new GeneralPractitioner(1, "Dr.Tree", "General Medicine", "GP001", 5);
        Gp1.AddAvailableSlot("08:00 - 09:00");
        Gp1.AddAvailableSlot("11:00 - 12:00");

        GeneralPractitioner Gp2 = new GeneralPractitioner(2, "Dr.Xie", "General Medicine", "GP002", 8);
        ...
        Appointment Appointment1 = new Appointment("Caius", "1273844343", "Flu Symptoms", "08:00 - 09:00", Gp1);
        Appointment1.PrintAppointmentDetails();

        System.out.println("------------------------------");

        Appointment Appointment2 = new Appointment("Aurelia", "1890797366", "Toothache", "15:00 - 16:00", Dentist1);
